...
export default async function NewPromptPage() {
  ...
  return (
    <div className="space-y-4">
      <div>
        <h1 className="text-2xl font-bold text-slate-900 dark:text-white">Create new prompt</h1>
        <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">Define a new AI prompt template</p>
      </div>
